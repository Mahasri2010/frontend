...
const StudentUpdate = () => {
    ...
    const SubmitHandler = event => {
        ...
        axios.patch(`http://127.0.0.1:4000/marks/update/${id}`, marks)
            .then(response => {
                response.data
                navigate('/student')
            })
    ...
    //     axios.get('http://127.0.0.1:400/marks/total/',calculation)
    //     .then(response=>{
    ...
    useEffect(() => {
        ...
        axios.get(`http://127.0.0.1:4000/marks/${id}/`)
            .then(response => {
                console.log(response.data)

                setName(response.data.studentname)
                setRoll(response.data.studentroll)
                setAge(response.data.studentage)
    ...
    return (
        ...
        <div>
            ...
            <form className='form'>
                ...
                <input className='form-control' placeholder='Total Marks' type="number" value={total} /> <br />
